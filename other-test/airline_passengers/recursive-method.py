...
df_predictions.index = df_predictions['Month']
predictions = df_predictions['Predictions'][training_data_len + n_last : training_data_len + day - n]
y_test = df_predictions['#Passengers'][training_data_len + n_last :training_data_len + day - n]
...
df_predictions_ridge.index = df_predictions_ridge['Month']
predictions_ridge = df_predictions_ridge['Predictions'][training_data_len + n_last : training_data_len + day - n]
y_test_ridge = df_predictions_ridge['#Passengers'][training_data_len + n_last : training_data_len + day - n]
...
df_predictions_dt.index = df_predictions_dt['Month']
predictions_dt = df_predictions_dt['Predictions'][training_data_len + n_last : training_data_len + day - n]
y_test_dt = df_predictions_dt['#Passengers'][training_data_len + n_last : training_data_len + day - n]
...
df_predictions_knn.index = df_predictions_knn['Month']
predictions_knn = df_predictions_knn['Predictions'][training_data_len + n_last : training_data_len + day - n]
y_test_knn = df_predictions_knn['#Passengers'][training_data_len + n_last : training_data_len + day - n]
...
plt.plot(df_predictions['#Passengers'][training_data_len + n_last : training_data_len + day - n])
